...
import top.syhan.netty.demo.domain.*;
import top.syhan.netty.demo.util.CacheUtil;
import top.syhan.netty.demo.util.FileUtil;
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        switch (fileTransferProtocol.getTransferType()) {
            ...
            case 2 -> {
                ...
                FileBurstInstruct fileBurstInstruct = FileUtil.writeFile("C:\\Users\\apple\\Desktop", fileBurstData);
