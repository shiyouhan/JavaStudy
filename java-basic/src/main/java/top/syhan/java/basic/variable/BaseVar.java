...
public class BaseVar {
    ...
    public static void main(String[] args) {
        ...
        // 负的单精度浮点数
        float floatNeDemo = -9.18f;

        // 科学技术法表示的 3.14*10^38,float 类型科表示的最大数
        float floatDemoWithSci = 3.14e38f;

        // 科学技术法表示的 1.79*10^308,double 类型科表示的最大数
        double doubleDemo = 1.79e308;

        /**
         * 以下为字符串类型
         * java 的字符类可表示标准的 ASCII 和 一个 Unicode 字符
         * */
